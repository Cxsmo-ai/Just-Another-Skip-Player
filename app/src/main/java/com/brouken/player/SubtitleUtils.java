...
class SubtitleUtils {
    ...
    public static String getSubtitleMime(Uri uri) {
        ...
        // PGS (Presentation Graphic Stream) - Image-based Blu-ray
        else if (path.endsWith(".sup")) {
        ...
        else if (path.endsWith(".dvb")) {
            return "application/dvbsubs";
        }
        // Default to SRT (SubRip)
        else {
    ...
    */
    ...
    public static boolean isSubtitleFile(DocumentFile file) {
        ...
        return name.endsWith(".srt") || name.endsWith(".ssa") || name.endsWith(".ass")
                || name.endsWith(".vtt") || name.endsWith(".ttml") || name.endsWith(".dfxp")
                // Image-based subtitles
                || name.endsWith(".sup") || name.endsWith(".idx")
                // Additional text formats
                || name.endsWith(".smi") || name.endsWith(".sami");
    }
